...
public class EditTextUtil {
    ...
    private static final int[] PY_VALUE = new int[]{-20319, -20317, -20304, -20295, -20292, -20283,
    ...
    public static final String[] PY_STR = new String[]{"a", "ai", "an", "ang", "ao", "ba", "bai", "ban",
